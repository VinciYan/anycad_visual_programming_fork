...
namespace AnyCAD.CoreNodes.Geometry
{
    ...
    public class GCircleNode : IGraphicItem
    {
        ...
        public TopoShape TopoShape => SketchBuilder.MakeCircle(new GPnt(mCirc.Location().x, mCirc.Location().y, mCirc.Location().z), mCirc.Radius(), new GDir(0,0,1));
        /// <summary>
        /// 通过中心位置和半径创建GCircleNode
        /// </summary>
        /// <param name="center">GPntNode类型的中心位置</param>
