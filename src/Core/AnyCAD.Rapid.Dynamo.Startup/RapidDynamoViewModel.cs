...
namespace AnyCAD.Rapid.Dynamo.Startup
{
    internal class RapidDynamoViewModel : DynamoViewModel
    {
        ...
        {
            startConfiguration.DynamoModel.PreferenceSettings.IsBackgroundPreviewActive = false;
            startConfiguration.DynamoModel.PreferenceSettings.DefaultRunType = RunType.Manual;
